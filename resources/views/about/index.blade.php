...
@section(section: 'title')
    ...
    @endsection
@section('navbar')
<x-nav active2="active" />
@endsection
@section('header')

   
<div class="hero-wrap js-fullheight" style="background-image: url('{{asset('direngine/images/bg_2.jpg')}}');">
  ...
  <section class="ftco-section">
    <div class="container">
        <div class="row d-md-flex">
            <div class="col-md-6 ftco-animate img about-image" style="background-image: url({{asset('direngine/images/about.jpg')}});"></div>
            </div>
